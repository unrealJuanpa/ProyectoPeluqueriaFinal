...
namespace ProyectoPeluqueriaFinal.Controllers
{
    public class ProveedorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_proveedor,Nombre_proveedor,teléfono")] Proveedor proveedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_proveedor,Nombre_proveedor,teléfono")] Proveedor proveedor)
        {
            if (ModelState.IsValid)
            {
